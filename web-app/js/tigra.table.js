...
function tigra_tables (
        ...
        if( str_tableclass !== null ){
            str_table = str_tableclass;
            obj_tables = (document.all ? document.all[str_table] : document.getElementsByClassName(str_table));
        }else{
            str_table = str_tableid;
            obj_tables = (document.all ? document.all[str_table] : document.getElementsId(str_table));
        }
        
        if (!obj_tables) return alert("Please check tigra tables class or Id");
