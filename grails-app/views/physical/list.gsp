...
<html>
    <head>
        ...
        function fAction(act){
          ...
          with( document.forms['frm'] ){
            ...
            if( act == "add" ){
              action = "${createLink(controller: 'physical'  ,action: 'add')}"
            }
            ...
            if( act == "edit" ){
              ...
              action = "${createLink(controller: 'physical'  ,action: 'edit')}"
            }
            
            if( act == "delete" ){
              alert("Disabled")
              return
              action = "${createLink(controller: 'physical'  ,action: 'delete')}"
            }
            
            if( act == "view" ){
              action = "${createLink(controller: 'physical'  ,action: 'view')}"
            }
    ...
    <body>
        ...
        <table id="dt" class="trtbx">
            ...
            <tr onclick="rowSelected(${list[i].physical_id})">
                <td>${list[i].doc_no}</td>
