...
<html>
    <head>
        ...
        function fAction(act){
          ...
          with( document.forms['frm'] ){
            ...
            if( act == "add" ){
              action = "${createLink(controller: 'transfer'  ,action: 'add')}"
            }
            ...
            if( act == "edit" ){
              ...
              action = "${createLink(controller: 'transfer'  ,action: 'edit')}"
            }
            
            if( act == "delete" ){
              alert("Disabled")
              return
              action = "${createLink(controller: 'transfer'  ,action: 'delete')}"
            }
            
            if( act == "view" ){
              action = "${createLink(controller: 'transfer'  ,action: 'view')}"
            }
    ...
    <body>
        ...
        <table id="dt" class="trtbx">
            ...
            <tr onclick="rowSelected(${list[i].transfer_id})">
                <td>${list[i].doc_no}</td>
