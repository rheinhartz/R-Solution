...
<html>
    <head>
        ...
        function fAction(act){
          ...
          with( document.forms['frm'] ){
            ...
            if( act == "add" ){
              action = "${createLink(controller: 'receiving'  ,action: 'add')}"
            }
            ...
            if( act == "edit" ){
              ...
              action = "${createLink(controller: 'receiving'  ,action: 'edit')}"
            }
            
            if( act == "delete" ){
              alert("Disabled")
              return
              action = "${createLink(controller: 'receiving'  ,action: 'delete')}"
            }
            
            if( act == "view" ){
              action = "${createLink(controller: 'receiving'  ,action: 'view')}"
            }
    ...
    <body>
        ...
        <table id="dt" class="trtbx">
            ...
            <tr onclick="rowSelected(${list[i].receiving_id})">
                <td>${list[i].doc_no}</td>
